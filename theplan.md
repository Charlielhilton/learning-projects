*This is a flexible and evolving plan. Each project reflects a skill and a story. I’m learning in public, and I’m building to learn.* 🚀

# 🧠 Ultralearning Developer Portfolio Plan (Full Stack JavaScript + Web Dev)

**Author**: Charlie Hilton
**Inspired by**: *Ultralearning* by Scott Young, Plan-outline created using *ChatGPT* with prompts from [Tina Huang](https://www.youtube.com/watch?v=SDIrnL6nUkE&ab_channel=TinaHuang) then developed for personal use.
...
#### 📌 Project 5: Full Stack CRUD App (e.g., Task Manager, Bookmark Tool, Habit Tracker)
